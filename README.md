...
### Installation/setup
1. Clone/fork the repository locally on your machine.
...
+ In the terminal, run `uv venv` to create a virtual environment (venv). 
...
5. To launch the application, go to `main/` and run `streamlit run main.py`.
